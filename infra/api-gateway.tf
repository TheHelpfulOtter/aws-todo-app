...
resource "aws_api_gateway_method_response" "api_gw_method_resp_root" {
  rest_api_id = aws_api_gateway_rest_api.api_gw.id
  resource_id = aws_api_gateway_rest_api.api_gw.root_resource_id
...
resource "aws_api_gateway_integration_response" "api_gw_integ_resp_root" {
  rest_api_id = aws_api_gateway_rest_api.api_gw.id
  resource_id = aws_api_gateway_rest_api.api_gw.root_resource_id
  http_method = aws_api_gateway_method.api_gw_method_root.http_method
  status_code = aws_api_gateway_method_response.api_gw_method_resp_root.status_code
}
